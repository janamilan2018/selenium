...
//lowes=.6678678
    ...
    private boolean isLoggedIn() {
        try {
            wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("specific-logged-in-element-selector")));
            return true;
...
//                failPromptCount++;
    ...
    public Iterator<Object[]> csvDataProvider() {
        ...
        List<String[]> csvData = readCsvFile("/home//home/ubuntu/FirsTestCase/Prompting.csv");
