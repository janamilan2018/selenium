...
//Ban Topics Detected for Prompt: A potential security risk has been identified in your prompt. It has been temporarily blocked for your protection. Please review our prompt guidelines or contact support for further assistance.
public class BanTopicTest {
...
//        driver = new ChromeDriver();
    ...
    public void tearDown() {
        ...
        ExtentTest summaryTest = extent.createTest("LLM Ban Topics Test");
    ...
    public void promtsMassages(String message) {
        ...
        try {
            ...
            if (alertText.contains("Ban Topics Detected for Prompt: A potential security risk has been identified in your prompt. It has been temporarily blocked for your protection. Please review our prompt guidelines or contact support for further assistance.\n")) {
            ...
            if (response.contains("Ban Topics Detected for Prompt: A potential security risk has been identified in your prompt. It has been temporarily blocked for your protection. Please review our prompt guidelines or contact support for further assistance.\n")) {
